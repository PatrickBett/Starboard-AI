...
import { Container, Row, Col, Button, Card, Form, Spinner, Dropdown } from 'react-bootstrap';
...
const UploadDeal = () => {
  ...
  const [selectedFile, setSelectedFile] = useState("Industrial.Template.v2.4.xlsx");
      ...
      return (
        <div className="text-center">
          ...
          <div className="text-start">
            {files.map((file) => (
              <div key={file.id} className="d-flex align-items-center mb-3 p-2 border-bottom">
                {renderFileIcon(file.type)}
                <span className="ms-3 text-decoration-underline">{file.name}</span>
              </div>
            ))}
          </div>
        ...
        <Container fluid className="px-0">
          <div className="d-flex align-items-center">
            ...
            <div className="d-flex justify-content-between align-items-center w-100">
              ...
              <Button variant="outline-primary" className="me-2" active>New Upload</Button>
              <Link to="/pipeline"> <Button variant="outline-secondary" className="me-2">Pipeline</Button></Link>
              <Link to="/settings"><Button variant="outline-secondary">Settings</Button></Link>
              </div>
